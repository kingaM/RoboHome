...
class House(object):
    ...
    def getVersion(self):
        ...
        for m in methodsJSON:
            dictVersion[m[0]] = {'name' : data.typesNice[m[0]], 'isPassive' : data.passive[data.types[m[0]]], 'methods': m[1], 'supportedBrands' : ['arduino', 'gadgeteer', 'lightwaveRF'], 'states' : data.states[m[0]]}
        finalDict = {}
